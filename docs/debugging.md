...
The Quickpay gateway keeps track of all events which are related to payment details and payment state updates. It uses a separate log, which is located in `log/quickpay.log`.

## Example

```
❯ tail -fn20 log/quickpay.log
...
D, [2018-03-17T16:48:44.104215 #45974] DEBUG -- : For order R066092806 redirect user to payment URL: https://www.quickpay.com/paymentscreen/issuer/select/ideal
...
D, [2018-03-17T16:48:50.927236 #45974] DEBUG -- : Created a Quickpay Customer for Spree user with ID cst_234890239
