module SpreeQuickpayGateway
  class Engine < ::Rails::Engine
    require 'spree/core'
    require 'quickpay-api-ruby'

    isolate_namespace SpreeQuickpayGateway
    ...
    def self.activate
      ...
      ::Rails.application.config.spree.payment_methods << Spree::Gateway::QuickpayGateway
